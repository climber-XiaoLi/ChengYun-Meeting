...
#include "../../../VideoApi/threadworker.h"
...
namespace {
struct qt_meta_tag_ZN12ThreadWorkerE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN12ThreadWorkerE = QtMocHelpers::stringData(
    "ThreadWorker"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN12ThreadWorkerE[] = {
...
Q_CONSTINIT const QMetaObject ThreadWorker::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12ThreadWorkerE.offsetsAndSizes,
    qt_meta_data_ZN12ThreadWorkerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12ThreadWorkerE_t,
        // Q_OBJECT / Q_GADGET
...
void *ThreadWorker::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12ThreadWorkerE.stringdata0))
