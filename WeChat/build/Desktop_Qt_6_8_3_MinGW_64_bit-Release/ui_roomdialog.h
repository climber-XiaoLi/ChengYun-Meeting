...
public:
    ...
    void setupUi(QDialog *RoomDialog)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/images/orange.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        RoomDialog->setWindowIcon(icon);
        ...
        lb_title->setTextInteractionFlags(Qt::TextInteractionFlag::LinksAccessibleByMouse|Qt::TextInteractionFlag::TextSelectableByMouse);
        ...
        pb_min->setIcon(icon1);
        pb_min->setIconSize(QSize(25, 25));
        ...
        pb_max->setIcon(icon2);
        pb_max->setIconSize(QSize(20, 20));
        pb_max->setAutoDefault(false);
        ...
        pb_close->setIcon(icon3);
        pb_close->setIconSize(QSize(12, 12));
        ...
        verticalSpacer = new QSpacerItem(20, 1000, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);
    ...
    void retranslateUi(QDialog *RoomDialog)
    {
        ...
        pb_min->setToolTip(QCoreApplication::translate("RoomDialog", "<html><head/><body><p>\346\234\200\345\260\217\345\214\226</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        pb_min->setText(QString());
#if QT_CONFIG(tooltip)
        pb_max->setToolTip(QCoreApplication::translate("RoomDialog", "<html><head/><body><p>\345\205\250\345\261\217</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        pb_max->setText(QString());
#if QT_CONFIG(tooltip)
        pb_close->setToolTip(QCoreApplication::translate("RoomDialog", "<html><head/><body><p>\345\205\263\351\227\255</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        ...
        cbb_special->setItemText(3, QCoreApplication::translate("RoomDialog", "\347\254\221\350\204\270", nullptr));
