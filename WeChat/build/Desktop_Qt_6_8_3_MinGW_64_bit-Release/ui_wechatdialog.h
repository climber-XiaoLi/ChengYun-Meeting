...
public:
    ...
    void setupUi(QDialog *WeChatDialog)
    {
        ...
        WeChatDialog->setMinimumSize(QSize(450, 600));
        QFont font;
        ...
        WeChatDialog->setWindowIcon(icon);
...
"color: rgb(255, 255, 255);"));
        ...
        layoutWidget = new QWidget(wdg_content);
        layoutWidget->setObjectName("layoutWidget");
        layoutWidget->setGeometry(QRect(-2, 81, 451, 76));
        ...
        pb_tool3 = new QToolButton(layoutWidget);
